...
const AccordianFaq = (props: any) => {
    ...
    return (
        <div className="flex flex-col bg-gray-50 py-2 px-2">
            ...
            <div className="px-4 flex-col py-2">
                <div className="flex border-b cursor-pointer focus:outline-none" onClick={(e: any) => { setcurtab(4) }}>  <div className="text-base py-2 flex-1"> What are Mealbox subscriptions? </div> <div className="py-2"> <DownSvg size={24} fill="#000000" /> </div> </div>
            ...
            <div className="px-4 flex-col py-2">
                <div className="flex border-b cursor-pointer focus:outline-none" onClick={(e: any) => { setcurtab(5) }}> <div className="text-base py-2 flex-1"> What are Mealbox subscriptions? </div> <div className="py-2"> <DownSvg size={24} fill="#000000" /> </div> </div>
                {curtab === 5 && <div className="flex text-xs p-2 text-justify"> Tired of scanning menus every day to decide what to order? Can’t deal with the hassle of grocery shopping & cooking at the end of a tiring day? An eat.fit subscription is just the thing for you.You can subscribe to one or more meals including breakfast, lunch, snacks & dinner. Once you subscribe, we take care of that meal for you every day! Yes, every single day until the end of your subscription. You can also set up your subscription to renew automatically with credit/ debt cards.  </div>
                }  </div>
        </div>
    )
