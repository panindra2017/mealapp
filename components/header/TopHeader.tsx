...
export const TopHeader = () => {
    return (
        <div className="flex flex-wrap    items-center shadow-lg w-full py-2 bg-red-700 ">
              <div className="px-4 ">
              <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-menu-2" width="34" height="34" viewBox="0 0 24 24" stroke-width="1.5" stroke="#ffffff" fill="none" stroke-linecap="round" stroke-linejoin="round">
